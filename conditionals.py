...
#Q6. Write a program that asks the user to enter their email address and checks
# whether it is valid or not. For the purpose of this exercise, you can make
# the assumption that a valid email address contains a “@” symbol and a “.” symbol.
email = input("Email: ")
if "@" in email and "." in email:
    print("Valid email address.")
else:
    print("Invalid email adderss.")
